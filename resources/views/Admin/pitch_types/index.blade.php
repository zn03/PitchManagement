...
<head>
    ...
    <title> Loại Sân | Quản Lý Bán Hàng</title>
...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('pitch_types.index')}}"><i class="fa fa-user-circle" aria-hidden="true"></i> QUẢN
                LÝ LOẠI SÂN</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="{{route('pitch_types.index')}}" data-toggle="tooltip" data-placement="bottom" title="LOẠI SÂN">LOẠI SÂN</a></li>
...
<div class="container-fluid al">
    ...
    <a href="{{ route('pitch_types.create')}}">
        <button class="nv btn add-new" type="button" data-toggle="tooltip" data-placement="top" title="Thêm Loại Sân">
        ...
        <table class="table table-striped table-bordered" id="myTable">
            ...
            @foreach($pitchTypes as $pitchType)
                <tr>
                    ...
                    <td>
                        {{number_format($pitchType->pitchtype_price, 0, ',', '.')}} VND
                    </td>
                    <td>
                        <a href="{{ route('pitch_types.edit',$pitchType) }}" title="Sửa" data-toggle="tooltip">
                            <i class="fa fa-pencil" aria-hidden="true"></i>

                        </a>
                        <form method="post" action="{{ route('pitch_types.destroy', $pitchType)}}">
                            @csrf
                            @method('DELETE')
