    ...
    <div class="panel-body">
        <table class="table table-striped table-bordered" id="myTable">
            ...
            <tr class="ex">
                ...
                <th width="auto">Trạng Thái Sân </th>
            ...
            @foreach($pitches as $pitch)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('pitches.edit',$pitch) }}" title="Sửa" data-toggle="tooltip">
                            <i class="fa fa-pencil" aria-hidden="true"></i>

                        </a>
                        <form method="post" action="{{ route('pitches.destroy', $pitch)}}">
                            @csrf
                            @method('DELETE')
                            <button>
                                <a class="delete" title="Xóa" data-toggle="tooltip"><i class="fa fa-trash-o"></i></a>
                            </button>
                        </form>
                    </td>
                    @endforeach
