...
$('.dangkylaithu a, a.register-car').on('click', function(){
	$.ajax({
		url: nv_base_siteurl + 'index.php?' + nv_name_variable + '=shops&' + nv_fc_variable + '=order&getcontent=1&nocache=' + new Date().getTime(),
		type: 'post',
		dataType: 'html',
		data: {id: $(".register-car").attr("data-register")},
		success: function(res) {
			$('#sitemodal').modal();
			$('#sitemodal .modal-body').html( res );
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
			$('.dangkylaithu a').prop('disabled', false);
		}
	});
})

$('.dangkylichhen a').on('click', function(){
	$.ajax({
		url: nv_base_siteurl + 'index.php?' + nv_name_variable + '=shops&' + nv_fc_variable + '=order&getcontent=2&nocache=' + new Date().getTime(),
		type: 'post',
		dataType: 'html',
		data: '',
		success: function(res) {
